...
import me.eskid.nhacks.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = NHacksWare.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (NHacksWare.moduleManager.isModuleEnabled(FontMod.class)) {
            if (shadow) {
