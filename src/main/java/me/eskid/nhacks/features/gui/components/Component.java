package me.eskid.nhacks.features.gui.components;
...
import me.eskid.nhacks.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.open) {
            ...
            if (ClickGui.getInstance().outline.getValue().booleanValue()) {
                if (ClickGui.getInstance().rainbowRolling.getValue().booleanValue()) {
                    ...
                    GlStateManager.shadeModel(7425);
                    GL11.glBegin(2);
                    Color outlineColor = ClickGui.getInstance().colorSync.getValue() != false ? new Color(Colors.INSTANCE.getCurrentColorHex()) : new Color(NHacksWare.colorManager.getColorAsIntFullAlpha());
        ...
        NHacksWare.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) PhobosGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
