...
import me.eskid.nhacks.features.modules.player.Freecam;
import me.eskid.nhacks.features.setting.Bind;
import me.eskid.nhacks.features.setting.Setting;
import me.eskid.nhacks.util.BlockUtil;
...
public class Selftrap
    ...
    private final me.eskid.nhacks.util.Timer offTimer = new me.eskid.nhacks.util.Timer();
    ...
    public void onDisable() {
        if (this.offhand.getValue().booleanValue()) {
            NHacksWare.moduleManager.getModuleByClass(Offhand.class).setMode(this.offhandMode);
            NHacksWare.moduleManager.getModuleByClass(Offhand.class).setMode(this.offhandMode2);
        }
    ...
    private boolean check() {
        ...
        this.switchItem(true);
        if (!this.freecam.getValue().booleanValue() && NHacksWare.moduleManager.isModuleEnabled(Freecam.class)) {
            return true;
        }
