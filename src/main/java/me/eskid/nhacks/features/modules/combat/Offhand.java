...
import me.eskid.nhacks.event.events.ProcessRightClickBlockEvent;
...
import me.eskid.nhacks.mixin.mixins.accessors.IContainer;
import me.eskid.nhacks.mixin.mixins.accessors.ISPacketSetSlot;
...
public class Offhand
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !NHacksWare.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
