...
public class Speed
    ...
    private boolean shouldReturn() {
        return NHacksWare.moduleManager.isModuleEnabled("Freecam") || NHacksWare.moduleManager.isModuleEnabled("Phase") || NHacksWare.moduleManager.isModuleEnabled("ElytraFlight") || NHacksWare.moduleManager.isModuleEnabled("Strafe") || NHacksWare.moduleManager.isModuleEnabled("Flight");
    }
        ...
        if (EntityUtil.isEntityMoving(Speed.mc.player) && !Speed.mc.player.collidedHorizontally && !BlockUtil.isBlockAboveEntitySolid(Speed.mc.player) && BlockUtil.isBlockBelowEntitySolid(Speed.mc.player)) {
            ...
            if (Speed.mc.player.posY >= this.startY + this.bounceHeight) {
                ...
                if (this.useTimer.getValue().booleanValue()) {
                    NHacksWare.timerManager.setTimer(1.0f);
                }
            }
            if (Speed.mc.player.posY == this.startY) {
                ...
                if (this.useTimer.getValue().booleanValue()) {
                    if (rnd) {
                        NHacksWare.timerManager.setTimer(1.3f);
                    } else {
                        NHacksWare.timerManager.setTimer(1.0f);
                    }
                }
