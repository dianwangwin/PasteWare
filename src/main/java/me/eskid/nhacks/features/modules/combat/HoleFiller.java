...
public class HoleFiller
    ...
    private void doHoleFill() {
        ...
        if (this.midSafeHoles.getValue().booleanValue()) {
            object = NHacksWare.holeManager.getMidSafety();
            synchronized (object) {
                targets = new ArrayList<BlockPos>(NHacksWare.holeManager.getMidSafety());
            }
        }
        object = NHacksWare.holeManager.getHoles();
        synchronized (object) {
            targets = new ArrayList<BlockPos>(NHacksWare.holeManager.getHoles());
        }
