...
public class Cosmetics
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!NHacksWare.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : NHacksWare.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
