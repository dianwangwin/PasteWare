package me.eskid.nhacks.features.modules.render;
...
import me.eskid.nhacks.util.DamageUtil;
import me.eskid.nhacks.util.EntityUtil;
import me.eskid.nhacks.util.RotationUtil;
...
public class Nametags
    ...
    private String getDisplayTag(EntityPlayer player) {
        ...
        if (this.totemPops.getValue().booleanValue()) {
            popStr = popStr + NHacksWare.totemPopManager.getTotemPopString(player);
        }
        String idString = "";
