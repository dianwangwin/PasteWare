...
import me.eskid.nhacks.features.modules.player.XCarry;
...
public class AutoArmor
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * (this.tps.getValue() != false ? NHacksWare.serverManager.getTpsFactor() : 1.0f)))) {
            if (!this.taskList.isEmpty()) {
