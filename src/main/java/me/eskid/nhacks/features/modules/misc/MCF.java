...
public class MCF
    ...
    private void onClick() {
        ...
        if (result != null && result.typeOfHit == RayTraceResult.Type.ENTITY && (entity = result.entityHit) instanceof EntityPlayer) {
            if (NHacksWare.friendManager.isFriend(entity.getName())) {
                NHacksWare.friendManager.removeFriend(entity.getName());
                ...
                NHacksWare.friendManager.addFriend(entity.getName());
