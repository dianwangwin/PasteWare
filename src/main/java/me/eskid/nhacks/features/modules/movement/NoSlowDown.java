...
import me.eskid.nhacks.event.events.KeyEvent;
...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && NHacksWare.moduleManager.getModuleByClass(Flight.class).isDisabled() && NHacksWare.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {
