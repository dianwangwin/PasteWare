...
public class Managers
    ...
    public Setting<String> command = this.register(new Setting<String>("Command", "NHacks.pub"));
    ...
    @Override
    public void onLoad() {
        NHacksWare.commandManager.setClientMessage(this.getCommandMessage());
    }
        ...
        if (event.getStage() == 2) {
            ...
            if (event.getSetting() != null && this.equals(event.getSetting().getFeature())) {
                if (event.getSetting().equals(this.holeThread)) {
                    NHacksWare.holeManager.settingChanged();
                }
                NHacksWare.commandManager.setClientMessage(this.getCommandMessage());
            }
        }
