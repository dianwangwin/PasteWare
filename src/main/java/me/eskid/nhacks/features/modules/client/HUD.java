...
import me.eskid.nhacks.event.events.Render2DEvent;
import me.eskid.nhacks.features.modules.Module;
import me.eskid.nhacks.features.modules.misc.ToolTips;
import me.eskid.nhacks.features.setting.Setting;
import me.eskid.nhacks.manager.TextManager;
...
public class HUD
    ...
    public void onUpdate() {
        for (final Module module : NHacksWare.moduleManager.sortedModules) {
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        switch (this.watermark.getValue()) {
            case PHOBOS: {
                this.renderer.drawString("Nhacks" + (this.modeVer.getValue() ? " Reborn" : ""), 2.0f, 2.0f, (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2) : this.color, true);
                break;
            }
            case EARTH: {
                this.renderer.drawString("PasteWare" + (this.modeVer.getValue() ? " Reborn" : ""), 2.0f, 2.0f, (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2) : this.color, true);
                break;
            }
            case CUSTOM: {
                this.renderer.drawString(this.customWatermark.getValue() + (this.modeVer.getValue() ? " " : ""), 2.0f, 2.0f, (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2) : this.color, true);
                break;
            }
        }
        ...
        if (this.arrayList.getValue()) {
            if (this.renderingUp.getValue()) {
                for (int k = 0; k < (this.alphabeticalSorting.getValue() ? NHacksWare.moduleManager.alphabeticallySortedModules.size() : NHacksWare.moduleManager.sortedModules.size()); ++k) {
                    final Module module = this.alphabeticalSorting.getValue() ? NHacksWare.moduleManager.alphabeticallySortedModules.get(k) : NHacksWare.moduleManager.sortedModules.get(k);
                    final String text = module.getDisplayName() + "§7" + ((module.getDisplayInfo() != null) ? (" [§f" + module.getDisplayInfo() + "§7" + "]") : "");
                    final Color moduleColor = NHacksWare.moduleManager.moduleColorMap.get(module);
                ...
                for (int k = 0; k < (this.alphabeticalSorting.getValue() ? NHacksWare.moduleManager.alphabeticallySortedModules.size() : NHacksWare.moduleManager.sortedModules.size()); ++k) {
                    final Module module = this.alphabeticalSorting.getValue() ? NHacksWare.moduleManager.alphabeticallySortedModules.get(NHacksWare.moduleManager.alphabeticallySortedModules.size() - 1 - k) : NHacksWare.moduleManager.sortedModules.get(k);
                    final String text = module.getDisplayName() + "§7" + ((module.getDisplayInfo() != null) ? (" [§f" + module.getDisplayInfo() + "§7" + "]") : "");
                    final Color moduleColor = NHacksWare.moduleManager.moduleColorMap.get(module);
        ...
        if (this.renderingUp.getValue()) {
            if (this.serverBrand.getValue()) {
                final String text2 = grayString + "Server brand " + "§f" + NHacksWare.serverManager.getServerBrand();
            ...
            if (this.potions.getValue()) {
                for (final PotionEffect effect : NHacksWare.potionManager.getOwnPotions()) {
                    final String text3 = this.altPotionsColors.getValue() ? NHacksWare.potionManager.getPotionString(effect) : NHacksWare.potionManager.getColoredPotionString(effect);
            ...
            if (this.speed.getValue()) {
                final String text2 = grayString + "Speed " + "§f" + NHacksWare.speedManager.getSpeedKpH() + " km/h";
            ...
            if (this.tps.getValue()) {
                final String text2 = grayString + "TPS " + "§f" + NHacksWare.serverManager.getTPS();
            ...
            final String text = grayString + "Ping " + "§f" + (ServerModule.getInstance().isConnected() ? ServerModule.getInstance().getServerPing() : NHacksWare.serverManager.getPing()) + (this.MS.getValue() ? "ms" : "");
            ...
            final String fpsText = grayString + "FPS " + "§f" + Minecraft.debugFPS;
            final String text = grayString + "Ping " + "§f" + NHacksWare.serverManager.getPing();
            if (this.renderer.getStringWidth(text) > this.renderer.getStringWidth(fpsText)) {
                if (this.ping.getValue()) {
                    this.renderer.drawString(text, (float) (width - (this.renderer.getStringWidth(text) + 2)), (float) (2 + k++ * 10), (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2 + k * 10) : this.color, true);
                }
        ...
        if (this.renderingUp.getValue()) {
            NHacksWare.notificationManager.handleNotifications(height - (k + 16));
        } else {
            NHacksWare.notificationManager.handleNotifications(height - (j + 16));
        }
        ...
        final String text4 = (this.direction.getValue() ? (NHacksWare.rotationManager.getDirection4D(false) + " ") : "") + (this.coords.getValue() ? coordinates : "") + "";
    ...
    public void renderLag() {
        final int width = this.renderer.scaledWidth;
        if (NHacksWare.serverManager.isServerNotResponding()) {
            final String text = ((this.lag.getValue() == LagNotify.GRAY) ? "§7" : "§c") + "Server not responding: " + MathUtil.round(NHacksWare.serverManager.serverRespondingTime() / 1000.0f, 1) + "s.";
