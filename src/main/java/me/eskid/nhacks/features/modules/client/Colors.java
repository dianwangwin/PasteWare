...
public class Colors
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().colorSync.getValue().booleanValue()) {
            NHacksWare.colorManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
    }
