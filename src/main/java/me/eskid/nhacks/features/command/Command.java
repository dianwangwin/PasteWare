package me.eskid.nhacks.features.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(NHacksWare.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            NHacksWare.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return NHacksWare.commandManager.getPrefix();
    }
