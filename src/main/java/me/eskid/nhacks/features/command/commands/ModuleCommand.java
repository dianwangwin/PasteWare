...
import me.eskid.nhacks.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : NHacksWare.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : NHacksWare.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = NHacksWare.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = NHacksWare.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
